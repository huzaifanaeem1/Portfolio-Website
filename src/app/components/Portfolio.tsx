...
export default function Portfolio() {
  ...
  <div className="container mx-auto text-center">
    <h2 className="text-3xl font-bold text-white mb-5">Check out my latest coding projects</h2>
    <p className="mb-8 text-white">These are some of the projects I’ve been working on recently. Each project demonstrates my skills in TypeScript and web development, from building functional calculators to complex quiz systems. Take a look, and feel free to explore the code on GitHub!</p>   
    <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-6">
      <div className="bg-red-900 p-5 rounded-lg hover:shadow-lg transition duration-300">
        <img src="https://img.freepik.com/premium-photo/3d-rendering-illustration-simple-calculator-white-background-calculator-is-orange-has-large-display-keys-are-grey-black_14117-120364.jpg" alt="Project 01" className="rounded-t-lg w-full object-cover h-40" />
        <h3 className="text-lg font-medium text-white mt-4">Project 01: Simple Calculator</h3>
        <p className="text-white mt-2"></p>
        <a href="https://github.com/huzaifanaeem1/my-typescript-simple-calculator" target="_blank" rel="noopener noreferrer" className=" bg-white rounded-full px-2 py-2 font-semibold text-red-700 hover:underline mt-2 block">Read More</a>
      </div>
      <div className="bg-red-900 p-5 rounded-lg hover:shadow-lg transition duration-300">
        <img src="https://img.freepik.com/premium-photo/photo-modern-atm-machine_1056572-29055.jpg?w=360" alt="Project 02" className="rounded-t-lg w-full object-cover h-40" />
        <h3 className="text-lg font-medium text-white mt-4">Project 02: ATM Machine</h3>
        <p className="text-white mt-2"></p>
        <a href="https://github.com/huzaifanaeem1/simple-typescript-atm-machine.git" target="_blank" rel="noopener noreferrer" className=" bg-white rounded-full px-2 py-2 font-semibold text-red-700 hover:underline mt-2 block">Read More</a>
      </div>
      <div className="bg-red-900 p-5 rounded-lg hover:shadow-lg transition duration-300">
  ...
  <div className="container mx-auto text-center">
    <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-6">
      <div className="bg-red-800 p-5 rounded-lg hover:shadow-lg transition duration-300">
        <img src="https://img.freepik.com/premium-photo/realty-free-images_1023251-415735.jpg" alt="Project 05" className="rounded-t-lg w-full object-cover h-40" />
        <h3 className="text-lg font-medium text-white mt-4">Project 05: Todo List</h3>
        <p className="text-white mt-2"></p>
        <a href="https://nextjs-todo-list-cyan.vercel.app/" target="_blank" rel="noopener noreferrer" className=" bg-white rounded-full px-2 py-2 font-semibold text-red-700 hover:underline mt-2 block">Read More</a>
      </div>
      <div className="bg-red-800 p-5 rounded-lg hover:shadow-lg transition duration-300">
...
<section className=" bg-red-900 text-white body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="text-center mb-20">
      <h1 className="sm:text-6xl text-7xl font-bold text-center title-font text-White mb-4">
      Project Features & Commands  
      </h1> 
      <p className="text-white text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">Explore the essential features of each Typescript project & easily run then using the npx command provided below:</p>
    </div>
    <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-100 rounded flex p-4 h-full items-center">
          ...
          <span className="text-red-800 title-font font-medium">npx my-typescript-simple-claculator</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-100 rounded flex p-4 h-full items-center">
