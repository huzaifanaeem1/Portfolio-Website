    ...
    <div id="Skill" className="bg-red-900 pt-20">
      <section className="pt-20">
        <div className="text-center mb-16 pt-10">
          <h1 className="sm:text-5xl text-4xl font-black title-font text-white mb-4">
            Skills
          </h1>
          <p className="text-white text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto px-4">
