    ...
    <div>
      <footer className="bg-white text-red-900 body-font">
        <div className="container px-5 py-8 mx-auto flex flex-col sm:flex-row items-center">
          <p className="text-lg font-bold text-center text-red-900 sm:ml-4 sm:pl-4 sm:py-2 sm:mt-0 mt-4">
            Huzaifa Naeem © 2024 All Rights Reserved
          </p>
